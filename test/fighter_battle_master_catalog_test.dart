...
void main() {
  ...
  test('all 16 PHB maneuvers are translated and structured', () {
    const expectedNames = {
      ...
      BattleMasterManeuverIds.evasiveFootwork: 'Passo Evasivo',
      BattleMasterManeuverIds.feintingAttack: 'Attacco con Finta',
      BattleMasterManeuverIds.goadingAttack: 'Attacco Provocatorio',
      BattleMasterManeuverIds.lungingAttack: 'Attacco in Affondo',
      ...
      BattleMasterManeuverIds.pushingAttack: 'Attacco Spingente',
      BattleMasterManeuverIds.rally: 'Incoraggiare',
      BattleMasterManeuverIds.riposte: 'Risposta',
      BattleMasterManeuverIds.sweepingAttack: 'Attacco Sferzante',
