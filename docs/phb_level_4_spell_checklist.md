# PHB livello 4 - checklist incantesimi

Checklist di lavoro per espandere `lib/data/spell_data.dart` con gli incantesimi di 4° livello del PHB.

- [x] Allucinazione Mortale
- [x] Aura di Purezza
- [x] Aura di Vita
- [x] Compulsione
- [x] Confusione
